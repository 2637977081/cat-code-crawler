	                	...
	                	"render": function ( data, type, row ) {
	                		return function(){
                                ...
                                var html = '<div class="btn-group">\n' +
                                    '     <button type="button" class="btn btn-mappers btn-sm">'+ I18n.system_opt +'</button>\n' +
                                    '     <button type="button" class="btn btn-mappers btn-sm dropdown-toggle" data-toggle="dropdown">\n' +
